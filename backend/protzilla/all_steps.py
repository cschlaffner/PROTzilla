...
_forward_mapping: list[Step] = [
    ...
    data_preprocessing.BatchEffectCorrectionComBat,
    data_preprocessing.BatchEffectCorrectionSVA,
    data_preprocessing.BatchEffectCorrectionLOESS,
    ...
    data_analysis.DimensionReductionPCA,
