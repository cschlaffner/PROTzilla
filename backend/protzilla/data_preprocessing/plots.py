...
from backend.protzilla.constants.colors import PLOT_PRIMARY_COLOR, PLOT_SECONDARY_COLOR
from backend.protzilla.data_preprocessing.plots_helper import generate_tics
from backend.protzilla.utilities import default_intensity_column, plot_template
