...
import { ButtonProps, ButtonRef, CSVButtonProps, StatusButtonProps, ToggleableButtonProps } from "./button.props";
  ...
  return (
    <>
      ...
      >
        ...
        {children}
        {(tag || tagTx) && (
          <Text className="text" txData={tagData} text={tag} tx={tagTx} style={textStyle} />
        )}
